...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLayer.Documents.Models.NotaryEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataLayer.Documents.Models.UserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DataLayer.Documents.Models.DocumentEntity", b =>
                {
                    ...
                    b.HasOne("DataLayer.Documents.Models.NotaryEntity", "Notary")
                        .WithMany()
                        .HasForeignKey("NotaryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DataLayer.Documents.Models.UserEntity", "User")
                        .WithMany()
